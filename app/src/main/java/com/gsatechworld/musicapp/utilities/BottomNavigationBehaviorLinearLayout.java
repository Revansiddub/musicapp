...
public class BottomNavigationBehaviorLinearLayout extends CoordinatorLayout.Behavior<LinearLayout> {

    public BottomNavigationBehaviorLinearLayout(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
    }

    public boolean layoutDependsOn(@Nullable CoordinatorLayout parent, @NonNull LinearLayout child,
    ...
    private void updateSnackbar(LinearLayout child, Snackbar.SnackbarLayout snackbarLayout) {
